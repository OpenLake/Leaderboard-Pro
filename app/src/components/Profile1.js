...
const Profile1 = ({darkmode}) => {
  ...
  return (
    <div style={{position:"absolute",backgroundColor:darkmode?"black":"", width:"100vw",height:"92vh", top: "8vh", zIndex: "1"}}>
      <button onClick={()=>setUpdate(!update)} style={{position:"absolute",top:"10px",right:"10px",backgroundColor:!darkmode ? "#39ace7" : "#2F4562",color:darkmode?"white":"black", zIndex: "1000"}}>Update usernames</button>
