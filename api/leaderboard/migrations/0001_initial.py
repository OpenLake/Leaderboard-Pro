# Generated by Django 3.2.1 on 2023-06-09 17:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_rating', models.PositiveIntegerField(default=0)),
                ('rating', models.PositiveIntegerField(default=0)),
                ('last_activity', models.BigIntegerField(default=253402300800.0)),
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('avatar', models.CharField(default='', max_length=256)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='leaderboard.contest')),
            ],
        ),
        migrations.CreateModel(
